...
function blog_posts() {
    ...
    let post_template = `
    <div class="blog-post more-blogs" onclick="blog_link_click('https://evelynjeong.tistory.com/');">

        <div class="blog-link">

            <h3><a href="https://evelynjeong.tistory.com/">Visit the blog for more posts</a></h3>            
