...
## Publications
1. **Seogyeong Jeong**, Jaehui Hwang, Dongyoon Han, Geonmo Gu, Alice Oh, Taekyung Kim. 2026. Beneath the Surface of Chain-of-Thoughts: A Mechanistic Interpretation of Reasoning Operations in LLMs. To appear in *The 2026 Conference on Empirical Methods in Natural Language Processing(2026 EMNLP Main Conference)*. Also to be presented at *The Ninth Workshop on Analyzing and Interpreting Neural Networks for NLP (BlackboxNLP 2026)*.
